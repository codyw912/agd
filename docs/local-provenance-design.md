...
1. Write local records while keeping existing trailers unchanged.
...
The first implementation should stop after step 1 unless verification fallback
is small enough to keep the PR reviewable.
